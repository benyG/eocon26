...
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  const { nameFr, nameEn, priceFr, priceEn, perksFr, perksEn, earlyBirdPriceFr, earlyBirdPriceEn, earlyBirdUntil, color, isFeatured, isVisible, ctfAccess, maxCapacity, sortOrder } = await req.json();
